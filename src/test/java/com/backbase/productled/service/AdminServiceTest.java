...
public class AdminServiceTest {
    ...
    public void setUp() throws IOException {
        ...
        legalEntityTask = new LegalEntityTask(
            objectMapper.readValue(new File("src/main/resources/legal-entity-hierarchy.json"),
                LegalEntity.class));
    }
    ...
    public void testExecuteTaskShouldCompleteManualSteps() {
        // Given
        when(adminApi.getToken(any(), any(), any(), any()))
        ...
        // When
        adminService.executeTask(legalEntityTask);
