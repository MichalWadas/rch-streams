...
/**
 * Initializes and injects beans for 'DepositTransactionsApi' and 'DepositAccountsApi' (in Mambu) using configuration properties
 */
@Configuration
public class MambuRestClientConfiguration {
    ...
    public ApiClient apiClient(MambuConfigurationProperties mambuConfigurationProperties, RestTemplate restTemplate) {
        ...
        apiClient.setBasePath(mambuConfigurationProperties.getBasePath());
        return apiClient;
    }
